...
let shipsData = [
	...
	{x : 10, y : 406, width : 4 * z, height : z, dir : "h", img : {"h" : "static/img/DestroyerH.png", "v" : "static/img/DestroyerV.png"}, cells : [], state : "out", valid : undefined, id : 3, name : "Destroyer"},
	{x : 10, y : 438, width : 5 * z, height : z, dir : "h", img : {"h" : "static/img/BattleshipH.png", "v" : "static/img/BattleshipV.png"}, cells : [], state : "out", valid : undefined, id : 4, name : "Battleship"}
];
